...
enum class StatsKey(private val key: String) {
    ...
    PROGSTUDY_SHOW_PHRASE_ASK_WORD_KANJI("ps-12"),
    PROGSTUDY_SHOW_SENTENCE_ASK_WORD_KANJI("ps-13"),
    PROGSTUDY_SHOW_TRANSLATION_ASK_KANJI_AMONG_SIMILAR("ps-14"),
    PROGSTUDY_SHOW_PHRASE_TRANSLATION_ASK_PHRASE_KANA("ps-15"),
    PROGSTUDY_SHOW_PHRASE_ASK_WORD_KANA("ps-16"),
    PROGSTUDY_SHOW_SENTENCE_ASK_WORD_KANA("ps-17");
